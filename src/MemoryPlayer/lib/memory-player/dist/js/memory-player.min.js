...
/**
     ...
     */
return a.prototype.$get=function(){var a=this;return{ids:this.JPlayerIds,instance:function(){return a.JPlayer}}},a.prototype.$setIds=function(a){this.JPlayerIds=a},a.prototype.$setInstance=function(a,b,c){var d=this;window.setTimeout(function(){
// Sets immutable jplayer instance
d.JPlayer=new jPlayerPlaylist(a,b,c)},300)},a}();!function(){"use strict";angular.module("MemoryPlayer").provider("JPlayer",MemoryPlayerProvider)}();var MemoryPlayerConfig=function(){function a(a,b){this.$locationProvider=a,this.JPlayerProvider=b,this.JPlayerIds={jPlayer:"#mp-jquery_jplayer",cssSelectorAncestor:"#mp-jp_container"},this.JPlayerOptions={swfPath:"/js/jquery.jplayer.swf",supplied:"mp3",wmode:"window",audioFullScreen:!1,smoothPlayBar:!1,keyEnabled:!1,playlistOptions:{enableRemoveControls:!1,displayTime:0,addTime:0,removeTime:0,shuffleTime:0}},this.JPlayerProvider.$setIds(this.JPlayerIds),this.JPlayerProvider.$setInstance(this.JPlayerIds,[],this.JPlayerOptions),this.$locationProvider.html5Mode({enabled:!0,requireBase:!1})}return a}();MemoryPlayerConfig.instance=["$locationProvider","JPlayerProvider",MemoryPlayerConfig];var MemoryPlayerRun=function(){function a(a,b){this.$rootScope=a,this.$window=b,this.$rootScope.$on("$locationChangeSuccess",function(a,b,c){b!==c&&(this.$window.location.href=b)})}return a}();MemoryPlayerRun.instance=["$rootScope","$window",MemoryPlayerRun],function(){"use strict";angular.module("MemoryPlayer").config(MemoryPlayerConfig.instance),angular.module("MemoryPlayer").run(MemoryPlayerRun.instance)}();var MemoryPlayerAPI=function(){/**
...
e.MemoryPlayerState.setTrack(a)})}})},300),/**
...
angular.element("#memory-player").removeClass("mp-loading")},300)},a.prototype.toggleDropdown=function(a){
...
this.$rootScope.$watch(function(){return e.MemoryPlayerState.getPlaylist()},function(a,b){
// If playlist changes then update
angular.isDefined(a)&&a!==b&&
// Updates current playlist
e.setShareVal("playlist",a._id)}),
// Watches state service for track change
this.$rootScope.$watch(function(){return e.MemoryPlayerState.getTrack()},function(a,b){
// If track changes then update
angular.isDefined(a)&&a!==b&&(
// Updates current track
e.setShareVal("track",a._id),e.isTimeUsed&&e.useTime(),/**
                 * Observes time updated.
                 */
angular.element(e.jPlayerId).bind($.jPlayer.event.timeupdate,function(a){e.$rootScope.$evalAsync(function(){
// Updates share link time
e.sharelinkTime=$.jPlayer.convertTime(a.jPlayer.status.currentTime)})}))}),
// Brief timeout for player ready
this.$timeout(function(){/**
             * Observes player loaded.
             */
angular.element(e.jPlayerId).bind($.jPlayer.event.loadeddata,function(a){e.$rootScope.$evalAsync(function(){
// Updates track length
e.trackDuration=a.jPlayer.status.duration})}),/**
             * Observes time updated.
             */
angular.element(e.jPlayerId).bind($.jPlayer.event.timeupdate,function(a){e.$rootScope.$evalAsync(function(){
// Updates share link time
e.sharelinkTime=$.jPlayer.convertTime(a.jPlayer.status.currentTime)})})},300)}/**
