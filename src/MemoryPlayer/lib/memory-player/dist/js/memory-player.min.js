...
/**
     ...
     */
return a.prototype.$get=function(){var a=this;return{ids:this.JPlayerIds,instance:function(){return a.JPlayer}}},a.prototype.$setIds=function(a){this.JPlayerIds=a},a.prototype.$setInstance=function(a,b,c){var d=this;window.setTimeout(function(){d.JPlayer=new jPlayerPlaylist(a,b,c)},200)},a}();!function(){"use strict";angular.module("MemoryPlayer").provider("JPlayer",MemoryPlayerProvider)}();var MemoryPlayerConfig=function(){function a(a,b){this.$locationProvider=a,this.JPlayerProvider=b,this.JPlayerIds={jPlayer:"#mp-jquery_jplayer",cssSelectorAncestor:"#mp-jp_container"},this.JPlayerOptions={wmode:"window",audioFullScreen:!1,smoothPlayBar:!1,keyEnabled:!1,playlistOptions:{enableRemoveControls:!1}},this.JPlayerProvider.$setIds(this.JPlayerIds),this.JPlayerProvider.$setInstance(this.JPlayerIds,[],this.JPlayerOptions),this.$locationProvider.html5Mode({enabled:!0,requireBase:!1})}return a}();MemoryPlayerConfig.instance=["$locationProvider","JPlayerProvider",MemoryPlayerConfig];var MemoryPlayerRun=function(){function a(a,b){this.$rootScope=a,this.$window=b,this.$rootScope.$on("$locationChangeSuccess",function(a,b,c){b!==c&&(this.$window.location.href=b)})}return a}();MemoryPlayerRun.instance=["$rootScope","$window",MemoryPlayerRun],function(){"use strict";angular.module("MemoryPlayer").config(MemoryPlayerConfig.instance),angular.module("MemoryPlayer").run(MemoryPlayerRun.instance)}();var MemoryPlayerAPI=function(){/**
...
return a.removePlayer(),a.$log.log("XHR Failed for getPlaylists."),b.data&&a.$log.log(b.data),null})},a}();MemoryPlayerAPI.instance=["$http","$log",MemoryPlayerAPI],function(){"use strict";angular.module("MemoryPlayer").service("MemoryPlayerAPI",MemoryPlayerAPI.instance)}();var MemoryPlayerControls=function(){/**
     ...
     */
function a(a,b,c,d){var e=this;this.$rootScope=a,this.$timeout=b,this.JPlayer=c,this.MemoryPlayerState=d,
...
this.$timeout(function(){/**
             ...
             */
angular.element(e.jPlayerId).bind($.jPlayer.event.volumechange,function(a){
// Updates volume
e.MemoryPlayerState.setVolume(a.jPlayer.options.volume),
// Updates is muted
e.MemoryPlayerState.setIsMuted(a.jPlayer.options.muted)}),/**
             * Observes current track ended.
             */
angular.element(e.jPlayerId).bind($.jPlayer.event.ended,function(){
// If playlist is not over then update state, else start from beginning
if(e.isEnd())e.$rootScope.$evalAsync(function(){
// Starts playlist from beginning
e.selectTrack(0)});else{
// Gets next track id
var a=e.MemoryPlayerState.getTrackId()+1;e.$rootScope.$evalAsync(function(){
// Updates current track
e.MemoryPlayerState.setTrack(a)})}})},200),/**
...
e.MemoryPlayerState.getIsPaused()||
// Pauses player
e.play()})}/**
...
a||angular.element(this.jPlayerId).trigger("MemoryPlayer.TrackPlayed")},a.prototype.previous=function(){
...
this.$timeout(function(){
// Sets playlist
c.JPlayer.instance().setPlaylist(c.MemoryPlayerState.getPlaylist().playlist),
// If settings exist then restart
angular.isDefined(b)&&
// Restarts player
c.restart(b),
// Removes loading class
angular.element("#memory-player").removeClass("mp-loading")},200)},a.prototype.toggleDropdown=function(a){
// Sets values to update dropdown state
var b=angular.element(a.target),c=b.closest(".mp-dropdown"),d=c.hasClass("open"),e=angular.element(document.createElement("div")).addClass("mp-dropdown-backdrop");
// Removes dropdown backdrop
...
c.addClass("open"),
// Updates aria for accessibility
b.closest(".mp-dropdown-toggle").attr("aria-expanded","true"))},a}();MemoryPlayerControls.instance=["$rootScope","$timeout","JPlayer","MemoryPlayerState",MemoryPlayerControls],function(){"use strict";angular.module("MemoryPlayer").service("MemoryPlayerControls",MemoryPlayerControls.instance)}();var MemoryPlayerState=function(){/**
...
// Updates current track
this.currentTrack=this.currentPlaylist.playlist[a]},a.prototype.getTrackId=function(){return this.currentTrack._id},a.prototype.getVolume=function(){return this.volume.toFixed(2)},a.prototype.setVolume=function(a){this.volume=a},a}();MemoryPlayerState.instance=["JPlayer",MemoryPlayerState],function(){"use strict";angular.module("MemoryPlayer").service("MemoryPlayerState",MemoryPlayerState.instance)}();var MemoryPlayerController=function(){function a(a,b,c){var d=this;this.$scope=a,this.MemoryPlayerState=b,this.MemoryPlayerControls=c,this.playlists=this.MemoryPlayerState.getPlaylists(),this.currentPlaylist=this.MemoryPlayerState.getPlaylist(),this.currentTrack=this.MemoryPlayerState.getTrack(),this.isPaused=this.MemoryPlayerState.getIsPaused(),this.$scope.$watch(function(){return d.MemoryPlayerState.getPlaylists()},function(a,b){angular.isDefined(a)&&a!==b&&(d.playlists=a)}),this.$scope.$watch(function(){return d.MemoryPlayerState.getPlaylist()},function(a,b){angular.isDefined(a)&&a!==b&&(d.currentPlaylist=a)}),this.$scope.$watch(function(){return d.MemoryPlayerState.getTrack()},function(a,b){angular.isDefined(a)&&a!==b&&(d.currentTrack=a)}),this.$scope.$watch(function(){return d.MemoryPlayerState.getIsPaused()},function(a,b){angular.isDefined(a)&&a!==b&&(d.isPaused=a)})}return a.prototype.maxVolume=function(){this.MemoryPlayerControls.maxVolume()},a.prototype.mute=function(){this.MemoryPlayerControls.mute()},a.prototype.next=function(){this.MemoryPlayerControls.next()},a.prototype.play=function(){this.MemoryPlayerControls.play()},a.prototype.previous=function(){this.MemoryPlayerControls.previous()},a.prototype.selectPlaylist=function(a){this.MemoryPlayerControls.selectPlaylist(a)},a.prototype.selectTrack=function(a){this.MemoryPlayerControls.selectTrack(a)},a.prototype.toggleDropdown=function(a){this.MemoryPlayerControls.toggleDropdown(a)},a}();MemoryPlayerController.instance=["$scope","MemoryPlayerState","MemoryPlayerControls",MemoryPlayerController],function(){"use strict";angular.module("MemoryPlayer").controller("MemoryPlayerController",MemoryPlayerController.instance)}();var MemoryPlayerDirective=function(){function a(b,c,d,e){var f=this;this.$location=b,this.MemoryPlayerAPI=c,this.MemoryPlayerState=d,this.MemoryPlayerControls=e,this.restrict="A",this.scope=!0,this.replace=!0,this.templateUrl="/lib/memory-player/dist/html/memory-player.html",a.prototype.link=function(a,b,c){a.isShareable=a.$eval(c.isShareable)||!1;var d=f.$location.search();f.MemoryPlayerAPI.getPlaylists().then(function(a){if(f.MemoryPlayerState.setPlaylists(a),isRestartable(d)){var b={track:parseInt(d.track),time:parseInt(d.time),volume:parseFloat(d.volume),isMuted:d.isMuted,isPaused:d.isPaused};f.MemoryPlayerControls.showtime(d.playlist,b)}else{var c=Object.keys(a)[0];f.MemoryPlayerControls.showtime(a[c]._id)}}),a.$on("$locationChangeStart",function(a,b,c){if(b!==c){var d=f.$location.url();f.$location.path(d.split("?")[0]).search({playlist:f.MemoryPlayerState.getPlaylistId(),track:f.MemoryPlayerState.getTrackId(),time:f.MemoryPlayerState.getTime(),volume:f.MemoryPlayerState.getVolume(),isMuted:f.MemoryPlayerState.getIsMuted(),isPaused:f.MemoryPlayerState.getIsPaused()})}})}}return a.instance=function(){var b=function(b,c,d,e){return new a(b,c,d,e)};return b.$inject=["$location","MemoryPlayerAPI","MemoryPlayerState","MemoryPlayerControls"],b},a}();!function(){"use strict";angular.module("MemoryPlayer").directive("memoryPlayer",MemoryPlayerDirective.instance())}();