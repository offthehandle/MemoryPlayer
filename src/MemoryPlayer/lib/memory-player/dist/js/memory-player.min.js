...
c.$rootScope.$broadcast("MP:Ready")})},a.prototype.toggleDropdown=function(a){
...
this.$rootScope.$watch(function(){return d.MemoryPlayerState.getVolume()},function(a,b){
// If track changes then update
angular.isDefined(a)&&a!==b&&
// Updates current track
d.setShareVal("volume",a)}),
// Waits for player ready
this.$rootScope.$on("MP:Ready",function(a){/**
